...
class WorkoutViewModelTest {
    ...
    private val workout1 = BodyWeightWorkout(
        workoutId = "workout-1",
    ...
    private val workout2 = BodyWeightWorkout(
        workoutId = "workout-2",
    ...
    /**
     * Verifies that calling [getWorkouts] on the view model invokes the corresponding
    ...
    /**
     * Verifies that calling [addWorkout] on the view model invokes the corresponding
     * method on the repository with the correct parameters.
     */
    @Test
    ...
    /**
     * Verifies that calling [updateWorkout] on the view model invokes the corresponding
     * method on the repository with the correct parameters.
     */
    @Test
    ...
    /**
     * Verifies that calling [deleteWorkoutById] on the view model invokes the corresponding
     * method on the repository with the correct parameters.
     */
    @Test
