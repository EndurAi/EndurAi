...
class UserAccountViewModelListsTest {
    ...
    private val friendAccount1 =
        UserAccount(userId = "2", firstName = "Friend1", lastName = "Last1")
    private val friendAccount2 =
        UserAccount(userId = "3", firstName = "Friend2", lastName = "Last2")
    ...
    fun `searchUsers calls onFailure when repository fails`() = runTest {
        ...
        userAccountViewModel.searchUsers(
            query = query,
            onResult = { fail("Unexpected success") },
