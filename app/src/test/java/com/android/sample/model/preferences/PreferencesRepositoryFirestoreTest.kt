...
class PreferencesRepositoryFirestoreTest {
    ...
    /**
     * This test verifies that when we update a new Preferences, the Firestore `set()` is called on the document
    ...
    /**
     * This test verifies that when fetching a Preferences class, the Firestore `get()` is called on the
