...
class BodyWeightWorkoutTest {
  ...
  fun testAddExercise() {
    ...
    val pushUps =
        BodyWeightExercise(EX_ID,BodyWeightExerciseType.PUSH_UPS, ExerciseDetail.RepetitionBased(15))
    ...
    fun testDeleteExerciseById() {
        ...
        val pushUps1 =
            BodyWeightExercise("001",BodyWeightExerciseType.PUSH_UPS, ExerciseDetail.RepetitionBased(15))
        workout.addExercise(pushUps1)

        val pushUps2 =
            BodyWeightExercise("002",BodyWeightExerciseType.PUSH_UPS, ExerciseDetail.RepetitionBased(15))
