    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                ...
                style = MaterialTheme.typography.labelLarge.copy(fontSize = FontSizes.MediumBigTitleFontSize),
                fontFamily = OpenSans,
                color = TitleBlue,
...
fun WorkoutList(navigationActions: NavigationActions, workoutViewModel: WorkoutViewModel<Workout>){
    ...
    LazyColumn(modifier = Modifier.padding(vertical = 20.dp).testTag("DoneWorkoutList").fillMaxHeight()) {
    ...
    Card(
        ...
        Row(
            ...
            Image(
                ...
                modifier = Modifier.size(70.dp).padding(horizontal = 15.dp).testTag("DoneCardImage")
            )
        }
    }
}
