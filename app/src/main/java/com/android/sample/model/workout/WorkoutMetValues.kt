...
/**
 * Class handling the MET values (Metabolic equivalent of task : kcal / hour * kg) which allow to
 * compute burnt calories during an exercise with the time and weight of the user
 */
