...
enum class ExerciseType(val workoutType: WorkoutType, val detail: ExerciseDetail, val hasMlFeedback: Boolean = false) {
  DOWNWARD_DOG(WorkoutType.YOGA, detail = ExerciseDetail.TimeBased(30, sets = 3), hasMlFeedback = true),
  ...
  WARRIOR_II(WorkoutType.YOGA, detail = ExerciseDetail.TimeBased(30, sets = 3), hasMlFeedback = true),
  PUSH_UPS(WorkoutType.BODY_WEIGHT, detail = ExerciseDetail.RepetitionBased(10), hasMlFeedback = true),
  SQUATS(WorkoutType.BODY_WEIGHT, detail = ExerciseDetail.RepetitionBased(15)),
  PLANK(WorkoutType.BODY_WEIGHT, detail = ExerciseDetail.TimeBased(60, sets = 1), hasMlFeedback = true),
  CHAIR(WorkoutType.BODY_WEIGHT, detail = ExerciseDetail.TimeBased(60, sets = 1), hasMlFeedback = true),
  JUMPING_JACKS(WorkoutType.WARMUP, detail = ExerciseDetail.RepetitionBased(20), hasMlFeedback = true),
