...
enum class AngleCriterionComments(val description: String) {
    ...
    R_HIP_KNEE_ANKLE_NOT_RIGHT("Keep an angle of 90 degree with your right leg."),
    L_HIP_KNEE_ANKLE_NOT_RIGHT("Keep an angle of 90 degree with your left leg."),
    BOTH_HIP_KNEE_ANKLE_NOT_RIGHT("Keep an angle of 90 degree with your legs."),
    ...
    SHOULDER_HIP_KNEE_NOT_RIGHT("Make sure you have a right angle between you shoulders, hips and knees")
