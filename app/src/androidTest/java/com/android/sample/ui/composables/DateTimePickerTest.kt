...
class DateTimePickerTest {
  ...
  fun displaysCorrectInitialTextWhenDateTimeIsNull() {
    composeTestRule.setContent {
      DateTimePicker(selectedDateTime = null, onDateTimeSelected = {}, title = "Select Date")
    }
  ...
  fun displaysCorrectInitialTextWhenDateTimeIsNotNull() {
    ...
    composeTestRule.setContent {
      DateTimePicker(selectedDateTime = dateTime, onDateTimeSelected = {}, title = "Select Date")
    }
