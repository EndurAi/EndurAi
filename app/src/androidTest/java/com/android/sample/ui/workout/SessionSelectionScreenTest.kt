...
class SessionSelectionScreenTest {
    ...
    /**
     * Verifies that all essential components of the session selection screen, including session cards,
    ...
    /**
     * Verifies that clicking the back button on the top app bar triggers a navigation action
    ...
    /**
     * Verifies that clicking on the "Body weight" session card triggers a navigation action
     * to the ImportOrCreate screen.
     */
    @Test
    ...
    /**
     * Verifies that clicking on the "Yoga" session card triggers a navigation action
     * to the ImportOrCreate screen.
     */
    @Test
