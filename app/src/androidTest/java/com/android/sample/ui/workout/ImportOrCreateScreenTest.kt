...
class ImportOrCreateScreenTest {
    ...
    fun displaysScreenCorrectly() {
        ...
        composeTestRule.setContent {
            ImportOrCreateScreen(navigationActions = navigationActions, workoutType = WorkoutType.BODY_WEIGHT)
        }
    ...
    fun displaysPromptMessageCorrectly() {
        ...
        composeTestRule.onNodeWithText("Do you want to create a new program from scratch or from an existing one?").assertExists()
    }
